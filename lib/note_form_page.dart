...
class _NoteFormPageState extends State<NoteFormPage> {
  ...
  // Warna preview berdasarkan logika deadline
  Color get previewColor {
    if (_deadline == null) return Colors.grey[300]!;
    final days = _deadline!.difference(DateTime.now()).inDays;
    if (days < 0) return Colors.red[900]!;
    if (days < 1) return Colors.red[400]!;
          ...
          child: ListView(
            children: [
              Container(
                ...
                child: const Text('Preview warna (berdasarkan deadline)',
              ...
              Row(
                children: [
                  Expanded(child: OutlinedButton(onPressed: _pickDeadline, child: const Text('Pilih Deadline'))),
                  const SizedBox(width: 10),
                  Expanded(child: OutlinedButton(onPressed: _clearDeadline, child: const Text('Hapus Deadline'))),
                ],
              ),
